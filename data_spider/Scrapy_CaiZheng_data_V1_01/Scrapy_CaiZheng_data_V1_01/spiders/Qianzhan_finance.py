...
class EQianzhan01Spider(scrapy.Spider):
    name = 'Qianzhan_finance'
    base_url = 'https://d.qianzhan.com'
    url_name = '前瞻数据库'

    # 2 价格指数
    cate = {
        '中国宏观-437': 'https://d.qianzhan.com/xdata/xsearch?q=%e8%b4%a2%e6%94%bf&cls=01&page=',
        '行业经济-4': 'https://d.qianzhan.com/xdata/xsearch?q=%e8%b4%a2%e6%94%bf&cls=02&page=',
        '区域宏观-60': 'https://d.qianzhan.com/xdata/xsearch?q=%e8%b4%a2%e6%94%bf&cls=04&page=',
    }
    ...
    def start_requests(self):
        ...
        p_name = '前瞻数据库'
        p_isRep = '前瞻数据库'
        mysql_config.insert(m_id, p_name, p_id, p_isRep)
...
if __name__ == '__main__':
    ...
    cmdline.execute(['scrapy', 'crawl', 'Qianzhan_finance'])
