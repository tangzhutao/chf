...
from Scrapy_Cultural_data_V1_01.MysqlPool import MysqlPool
...
class MongoDBPipeline(object):
    ...
    def close_spider(self, spider):
        ...
        config.SpiderLog('Cultural_data 文化资源', spider.name, update_time, self.count, update_menu, spider.base_url, spider.url_name)
        self.client.close()
