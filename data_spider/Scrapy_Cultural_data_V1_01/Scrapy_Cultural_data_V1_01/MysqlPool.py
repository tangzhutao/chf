...
from Scrapy_Cultural_data_V1_01 import ApolloConfig as Config
...
class MysqlPool(object):
    ...
    def change_state(self, cookie):
        try:
            sql2 = "update %s set state = 1 where phonenumber = '%s'" % (Config.MYSQL_TABLE_COOKIE, cookie['phonenumber'])
