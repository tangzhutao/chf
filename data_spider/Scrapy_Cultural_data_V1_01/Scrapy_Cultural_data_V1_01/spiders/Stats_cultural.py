...
class Stats01Spider(scrapy.Spider):
    ...
    # u=1; experience=show; _trs_uv=kc1qy830_6_13w3; JSESSIONID=2953F6A24C6F4BFADC4851FE8C20E496
    COOKIE = {
        'u': '1',
        'experience': 'show',
        '_trs_uv': 'kc1qy830_6_13w3',
        'JSESSIONID': '2953F6A24C6F4BFADC4851FE8C20E496',
    }
    ...
    def start_requests(self):
        ...
        for k, v in self.data.items():
            if not config.select(k, menu_id, v['id']):
                n = config.select_count(menu_id) + 1
...
if __name__ == '__main__':
    ...
    cmdline.execute(['scrapy', 'crawl', 'Stats_cultural'])
