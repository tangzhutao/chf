...
MONGO_DB = config.get("MONGO_INDUSTRY")
MONGO_COLLECTION = config.get("MONGO_COLLECTION_DATA")


if __name__ == '__main__':
    print(MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DATABASE, MYSQL_CHRASET, MYSQL_TABLE_DATA, MYSQL_TABLE_COOKIE, MYSQL_TABLE_LOG)
