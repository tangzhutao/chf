...
from Scrapy_E_Data_V1_01.MysqlPool import MysqlPool
...
class MongoDBPipeline(object):
    ...
    def close_spider(self, spider):
        ...
        mysql_config.SpiderLog('E(47.48.49.50)_data 建筑业', spider.name, update_time, self.count, update_menu, spider.base_url, spider.url_name)
        self.client.close()
