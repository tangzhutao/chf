...
class ChinaluqiaoV1Spider(scrapy.Spider):
    ...
    base_url = 'http://news.9to.com/list.php/catid-512/'
    url_name = '中国路桥资讯'

    url2 = {
        '481-行业资讯-2': 'http://news.9to.com/list.php/catid-508-page-',
        '481-行业资讯-3': 'http://news.9to.com/list.php/catid-507-page-',
        '481-企业新闻-2': 'http://news.9to.com/list.php/catid-249-page-',
        '481-新闻资讯-2': 'http://news.9to.com/list.php/catid-512-page-',
    }

    def start_requests(self):
        for c, u in self.url2.items():
            cs = c.split('-')
