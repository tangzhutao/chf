...
from Scrapy_E_repo_V1_01.MySQL_Pool import Mysql
from urllib3 import encode_multipart_formdata
from Scrapy_E_repo_V1_01.settings import SPIDER_NAME, UPLOADURL
from Scrapy_E_repo_V1_01.proxy import get_proxy, get_status
...
class MongoPipeline(object):
    ...
    def close_spider(self, spider):
        ...
        MysqlConfig.SpiderLog('E(47.48.49.50)_repo', spider.name, update_time, self.count, update_menu_count, spider.base_url,
                        spider.url_name)
        MysqlConfig.dispose()
        self.client.close()
